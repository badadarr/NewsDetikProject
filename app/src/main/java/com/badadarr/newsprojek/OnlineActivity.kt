...
import com.badadarr.newsprojek.databinding.ActivityOnlineBinding
import com.badadarr.newsprojek.databinding.ItemListNewsBinding
import com.badadarr.newsprojek.remote.POJO.ArticlesItem
import com.badadarr.newsprojek.remote.RetrofitInterfaces
import com.badadarr.newsprojek.remote.RetrofitService
import com.badadarr.newsprojek.rv.ItemListNewsAdapter
...
class OnlineActivity : AppCompatActivity() {
    ...
    private lateinit var adapterRV: ItemListNewsAdapter
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            Glide.with(this).load(R.drawable.traveloka_gambar).into(binding.imgToolbar)
